...
[![](https://img.shields.io/badge/supervisely-ecosystem-brightgreen)](https://ecosystem.supervisely.com/apps/YOUR_ORG/YOUR_REPO/export_to_osm)
[![](https://img.shields.io/badge/slack-chat-green.svg?logo=slack)](https://supervisely.com/slack)
![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/YOUR_ORG/YOUR_REPO)
[![views](https://app.supervisely.com/img/badges/views/YOUR_ORG/YOUR_REPO/export_to_osm.png)](https://supervisely.com)
[![runs](https://app.supervisely.com/img/badges/runs/YOUR_ORG/YOUR_REPO/export_to_osm.png)](https://supervisely.com)
